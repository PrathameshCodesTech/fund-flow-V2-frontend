        ...
        <div className="flex items-center gap-3">
          {isApproved ? (
            <>
              ...
              <div>
                <p className="text-sm font-semibold text-emerald-700 dark:text-emerald-400">Approved and Activated</p>
...
export default function FinanceVendorReviewPage() {
  ...
  const approveMutation = useMutation({
    ...
    onSuccess: () => {
      toast.success("Vendor approved and activation email sent");
