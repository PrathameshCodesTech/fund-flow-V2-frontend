/**
 * ActivatePage — set-password page for internal user activation links.
 *
...
import { validateInternalActivationToken, setInternalActivationPassword } from "@/lib/api/auth";
...
export default function ActivatePage() {
  ...
  const validateMutation = useMutation({
    mutationFn: () => validateInternalActivationToken(uid!, token!),
  ...
  const passwordMutation = useMutation({
    mutationFn: (pw: string) => setInternalActivationPassword({ uid: uid!, token: token!, password: pw }),
    onSuccess: () => {
      setSuccess(true);
        ...
        <div className="max-w-sm w-full">
          <div className="flex flex-col items-center text-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Your account is now active. Redirecting you to log in…
              </p>
            </div>
            <a
              href="/login"
